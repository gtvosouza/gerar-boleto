	...
	GeradorDeBoleto.prototype.gerarPDF = function(args) {
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				pdf.font('normal')
					.fontSize(pagador.getIdentificacao().length > 60 ? 8 : args.tamanhoDaFonte) // TODO: Diminuir tamanho da fonte caso seja maior que X caracteres
				...
				var primeiraLinhaOpcional = primeiraLinha + ESPACO_ENTRE_LINHAS + 10,
