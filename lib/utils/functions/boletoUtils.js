...
var Beneficiario = (function () {
  ...
  Beneficiario.prototype.comCodigoCedente = function (_codigoCedente) {
    this._codigoCedente = _codigoCedente;
    return this;
  };

  Beneficiario.prototype.getCodigoCedente = function () {
    return this._codigoCedente;
  };
...
var Datas = (function () {
  ...
  Datas.prototype.comDocumento = function (_documento, locate = "usa") {
    ...
    if (!validarData(_documento)) {
      throw new Error(
        "O ano do documento deve ser maior que 1997 e menor que 2028"
      );
    }
  ...
  Datas.prototype.comVencimento = function (_vencimento, locate = "usa") {
    ...
    if (!validarData(_vencimento)) {
      throw new Error(
        "O ano do documento deve ser maior que 1997 e menor que 2025"
      );
    }
...
var Boleto = (function () {
  ...
  Boleto.prototype.getFatorVencimento = function () {
    ...
    let fator = Math.floor(diferencaEmDias).toString();

    if (vencimento >= new Date("2025-02-22")) {
      fator = fator - 9000;
