...
var Beneficiario = (function () {
	...
	Beneficiario.prototype.getCodigoCedente = function (_codigoCedente) {
...
var Datas = (function () {
	...
	Datas.prototype.comDocumento = function (_documento,locate = 'usa') {
		...
		if (!validarData(_documento)) {
			throw new Error('O ano do documento deve ser maior que 1997 e menor que 2028');
		}
	...
	Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
		...
		if(!validarData(_vencimento)){
			throw new Error('O ano do documento deve ser maior que 1997 e menor que 2025');
		}
